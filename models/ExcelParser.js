...
class ExcelParser {
  ...
  constructor(excelFile) {
    ...
    var nttSystemColumns = getSheetColumns(nttSystem);
    var tableNTTSystem = {
      stack: nttSystemColumns[0],
      skill: nttSystemColumns[1],
      rating: nttSystemColumns[2]
    };
